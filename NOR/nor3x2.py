...
circuit = Circuit('NOR 3x2')
circuit.include("./data/sky130.sp")
circuit.V('vdd', 'vdd', 'gnd', '1.8v')

circuit.X('X1', 'sky130_fd_pr__pfet_01v8', 'n1', 'a', 'vdd', 'vdd', W='7000000u', L='150000u')
circuit.X('X2', 'sky130_fd_pr__pfet_01v8', 'n2', 'b', 'n1', 'n1', W='7000000u', L='150000u')
circuit.X('X3', 'sky130_fd_pr__pfet_01v8', 'd', 'c', 'n2', 'n2', W='7000000u', L='150000u')
circuit.X('X4', 'sky130_fd_pr__nfet_01v8', 'd', 'a', 'gnd', 'gnd', W='840000u', L='150000u')
circuit.X('X5', 'sky130_fd_pr__nfet_01v8', 'd', 'b', 'gnd', 'gnd', W='840000u', L='150000u')
circuit.X('X6', 'sky130_fd_pr__nfet_01v8', 'd', 'c', 'gnd', 'gnd', W='840000u', L='150000u')
...
V2.period = 10@u_ns
V3.period = 10@u_ns
V1.pulse_width = 5@u_ns
V2.pulse_width = 5@u_ns
V3.pulse_width = 5@u_ns
...
results = open("Results_nor_3x2_pdf.csv", "w")
